...
# pretrainedmodel_path = curdir + "/fine_tuned_model/{}/{project}/{}".format(model,project,train_percentage)
train_data, parse_data, logs = prepare_data(project=project,max_num=max_num)
